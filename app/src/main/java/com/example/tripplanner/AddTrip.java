...
public class AddTrip extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        source = findViewById(R.id.place_autocomplete_fragment);
        destination = findViewById(R.id.place_autocomplete_fragment2);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                placeName = source.getText().toString();
                placeDestination = destination.getText().toString();
                lat1 = 43.764673;
                long1 = -79.340441;
                lat2 = 43.769546;
                long2 = -79.382790;
                ...
                if (trip_name.matches("") || alarmClock.getText().toString().matches("") || alarmDate.getText().toString().matches("") || long1 == 0.0 || long2 == 0.0 || (!single.isChecked() && !round.isChecked())) {
                    ...
                    if (single.isChecked()) {
                        ...
                        tripDTO.setTrip_status(com.example.tripplanner.database.dto.Status.UPCOMING);
                    ...
                    if (round.isChecked()) {
                        if (myCalendarRound.compareTo(myCalendar) <= 0) {
                            ...
                            tripDTO2.setTrip_status(com.example.tripplanner.database.dto.Status.UPCOMING);
