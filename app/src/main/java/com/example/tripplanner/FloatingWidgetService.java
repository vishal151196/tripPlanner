...
public class FloatingWidgetService extends Service implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.open_activity_button:
                ...
                Intent intent = new Intent(FloatingWidgetService.this, NavigationDrawer.class);
    ...
    private void onFloatingWidgetClick() {
        if (isViewCollapsed()) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.list_item, R.id.item, noteList);
            ListView listView = (ListView) expandedView.findViewById(R.id.note_listView);
